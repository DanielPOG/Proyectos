        ...
        <main>
            <div class="container mt-3">   
                <div class="row justify-content-center align-items-center g-2">
                    <form action="ctrlpost.php" method="post">
                        <div class="mb-3">
                            <label for="columnas" class="form-label">Columnas</label>
                            <input type="number" class="form-control" id="columnas" name="columnas">
                        ...
                        <div class="mb-3">
                            <label for="pepe" class="form-label">Contenido</label>
                            <input type="text" class="form-control" id="pepe" name="pepe">
                        </div>
